...
namespace Aprenda.Backend.Migrations
{
    ...
    [Migration("20250926021132_UpdateArchiveModelWithMetadata")]
    partial class UpdateArchiveModelWithMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aprenda.Backend.Models.Submission", b =>
                {
                    b.HasOne("Aprenda.Backend.Models.Grade", "Grade")
                        .WithOne("Submission")
                        .HasForeignKey("Aprenda.Backend.Models.Submission", "GradeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
