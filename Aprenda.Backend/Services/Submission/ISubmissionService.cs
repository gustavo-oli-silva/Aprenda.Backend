...
public interface ISubmissionService
{
    ...
    Task<IEnumerable<Dtos.Submission.SubmissionDto>> GetAllSubmissionsByHomeworkIdAsync(long homeworkId);
    ...
    Task UpdateStatusAsync(long id, ESubmissionStatus status);
